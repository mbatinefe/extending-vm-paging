...
Before starting the loop yield for another process to run.
*/
...
uint16_t program[] = {        
    ...
    /*mem[0x300A]=*/   0xF028,    //  1111 0000 0010 1000             YIELD           ;yield for another process to run
    ...
    /*mem[0x300A]=*/   0xF028,    //  1111 0000 0010 1000             YIELD           ;yield for another process to run (and save PCB)
...
int main(int argc, char** argv) {
    char *outf = "programs/yld_code.obj";
    ...
    char *outff = "programs/yld_heap.obj";
